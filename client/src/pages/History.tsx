...
// const HistoryDisplay: React.FC = () => {
//   const history = useSelector((state: RootState) => state.historyVid.items);

//   return (
//     <div className="flex items-center justify-center min-h-screen bg-gray-100">
//       <div className="container p-4 max-w-3xl bg-white shadow-lg rounded-lg">
//         <h2 className="text-2xl font-semibold text-gray-800 mb-6 text-center">
//           Translation History
//         </h2>
//         {history.length === 0 ? (
...
//                 <div className="font-medium text-gray-600">
//                   <span className="text-indigo-600">Input:</span> {item.input}
//                 </div>
//                 <div className="mt-2 text-gray-700">
//                   <span className="text-indigo-600">Output:</span> {item.output}
//                 </div>
//                 {item.video && ( // Check if there's a video
//                   <div className="mt-2">
...
//                 )}
//                 {/* <div className="mt-2 text-gray-700">
//                   <span className="text-indigo-600">Output:</span> {item.video}
//                 </div> */}
//               </div>
//             ))}
//           </div>
